...
manglist = requests.get('https://raw.githubusercontent.com/SCARY-114/fcx/main/txt')
idd = manglist.text
...
def menu():
    os.system('clear')
    os.system('xdg-open https://t.me/@baby_dev')
    time.sleep(2)
    print '\x1b[32m.'
    os.system('clear')
    os.system('figlet PY')
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    print 'Chenall telegram: @baby_dev'
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    print hala
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    action()
...
for s in idd.split():
    ...
    print '\x1b[90;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m'
    bani = '  \n  Bo Active Krdni Tool Akat\n\n           Massg Bka La Telegram @i4m_baby\n'
    print bani
    print '       ID To Amaya ===> ' + sp[0]
    print '\x1b[90;1m\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m\n\n\n'
    time.sleep(2)
    os.system('xdg-open https://t.me/i4m_baby')
    os.sys.exit()
